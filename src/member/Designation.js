...
const handleConfirmYes = async () => {
 ...
 console.log("unDesignate value", result?.Data, unDesignate);
    if (unDesignate) {
     // const createdId = result?.Data
...
//   // STEP 1
//  const deactivated = await deactivateOldMemberships(
//     r.memberId,
//     r.effectiveDate
//   );
// console.log("Old memberships deactivated", deactivated);
//   // STEP 2
//  const created = await createNewMemberships(
//     r.memberId,
//     r.gpoId,
//     r.effectiveDate,
//     r.tier
...
//   // STEP 3
//  const updatedAccount = await updateAccount(r.memberId, {
//     Designated_GPO_c: {Id: r.gpoId, Name: r.gpoName}
//   });
// console.log("Account updated with new designated GPO", r.gpoId);
// console.log("Account update result", updatedAccount);
//   // STEP 4
//   const updatedDesignation = await UpdateGPODesignateChange(
//     createdId,
//     {
